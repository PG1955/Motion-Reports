...
if __name__ == "motion":
    ...
    while not killer.kill_now:
        ...
        #     tcsv.log_point('Save YOLO Frame')
        ...
        # # Resize the frame.
        # frame = resize_img(frame, (lores_width, lores_height))
        # tcsv.log_point('Resize Frame')
        # if not os.name == 'nt':
        ...
        if motion.sig_usr1:
            ...
            if yolo_output:
                ...
                yolo_peak_movement_frame = main_frame
        ...
        if movement_flag:
            ...
            # Write Timelapse jpg file.
            if 0 < timelapse_frame_number == frames_written and \
                    recording:
            ...
            if movement_peak < movement_level:
                ...
                if not box_jpg == 'OFF':
                    ...
                    jpeg_frame = draw_box(jpg_frame, box_text, contour, box_jpg_rgb, box_thickness, box_font_size)
            ...
            if not box == 'OFF':
                if not contour == (0, 0, 0, 0):
                    ...
                    frame = draw_box(frame, box_text, contour, box_rgb, box_thickness, box_font_size)
        ...
        # ==========================================================`
        # save the frame to the buffer_frame and put the latest frame in bf.
        # ==========================================================`
        ...
        # ========================================
        # Write mp4 from the buffer_frame.
        # ========================================
